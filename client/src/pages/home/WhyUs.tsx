...
const threads = [
  { letter: "T", title: "Tecnologia educativa con proposito", tone: "from-[#f78c16] to-[#ef6a00]" },
  { letter: "E", title: "Educacion para la transformacion", tone: "from-[#48d3df] to-[#19a9ce]" },
  { letter: "J", title: "Justicia social", tone: "from-[#1e5d9f] to-[#15457c]" },
  { letter: "I", title: "Innovacion e investigacion", tone: "from-[#71e2eb] to-[#31b9d2]" },
  { letter: "D", title: "Desarrollo comunitario", tone: "from-[#0f8e92] to-[#0a6c74]" },
  { letter: "O", title: "Organizacion estrategica con impacto", tone: "from-[#ff9b1f] to-[#ff7b00]" },
    ...
    <section id="tejidos" className="relative overflow-hidden bg-primary/5 py-24 md:py-28">
      ...
      <div className="container relative z-10 mx-auto px-6">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <Reveal delay={0.08}>
            <p className="mt-5 max-w-4xl text-lg leading-relaxed text-slate-700 md:text-2xl">Cada hilo representa un principio educativo que, al entrelazarse, hacen posible la transformacion de instituciones, organizaciones y comunidades.</p>
          </Reveal>
        </div>
